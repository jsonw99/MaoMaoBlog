...
import com.jw.maoblog.domain.*;
import com.jw.maoblog.domain.es.EsBlog;
import com.jw.maoblog.repository.BlogRepository;
...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public Page<Blog> listBlogsByTitleTag(User user, String title, Pageable pageable) {
		// fuzzy search
		title = "%" + title + "%";
		String tags = title;
		Page<Blog> blogs = blogRepository.findByTitleLikeAndUserOrTagsLikeAndUser(title,user, tags,user, pageable);
		return blogs;
	}
